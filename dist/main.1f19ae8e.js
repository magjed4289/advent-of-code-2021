...
//  //for (var j = 0; j < 4; j++) {
//    for (let i = 0; i < n - 2; i++) {
//      const sum = Number(arr[i]) + Number(arr[i + 1]) + Number(arr[i + 2]);
//      //document.write("////");
  ...
  for (var i = 0; i < arr.length; i++) {
    ...
    for (var key in obj) {
      ...
      switch (key) {
        ...
        default:
          console.log("Something is not rght!");
      }
    }
  }
